...
<?php require_once __DIR__ . '../public/navbar/navbar.php'; ?>
    ...
    <section id="page-banner" class="pt-105 pb-130 bg_cover" data-overlay="8" style="background-image: url(../public/images/page-banner-4.jpg)">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="#">
                                                <div class="singel-post">
                                                    <div class="thum">
                                                        <img src="../public/images/blog/blog-post/bp-1.jpg" alt="Blog">
                                                    </div>
                                                    <div class="cont">
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="singel-post">
                                                    <div class="thum">
                                                        <img src="../public/images/blog/blog-post/bp-2.jpg" alt="Blog">
                                                    </div>
                                                    <div class="cont">
