<?php
 require_once __DIR__ . '/student_ini/header.php'; 
$more = (isset($_GET['more']) ? ($_GET['more']) : null);

?>
<div class="nav-scroller py-1 mb-2">
    <nav class="nav ">
        <a class="p-2 text-muted" href="student.php">Back</a>
...
<div class="row mb-2">
    <!-- card -->
    <?php $cards = $db->select("SELECT * From courses WHERE id = $more  LIMIT 1"); ?>
    <?php if (mysqli_num_rows($cards) > 0) :
        foreach ($cards as $card) :
    ?>
            <div class="col-md-12">
                <div class="card mb-4 box-shadow">
                    <img class="card-img-top" width="150px" src="../courseThubnail/<?php echo  $card['thubnial']; ?>" alt="Card image cap">
...
<main role="main" class="container">
    <div class="row">
        <div class="col-md-8 blog-main">
            <h3 class="pb-3 mb-4 font-normal border-bottom">
                From the Firehose
            </h3>
...
<?php  require_once __DIR__ . '/student_ini/footer.php'; ?>